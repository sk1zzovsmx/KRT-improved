...
- Canonical release prep bundle: `python3 tools/krt.py release-prepare --current-tag v<version> --output-dir dist --json`
...
- `tools/krt.py release-prepare`: builds release notes from previous tag to current tag plus ZIP/checksum
