...
local upper = assert(_G.string.upper)
local lower = assert(_G.string.lower)
local sub = assert(_G.string.sub)
local tonumber = assert(_G.tonumber)
local type = assert(_G.type)
local error = assert(_G.error)
local select = assert(_G.select)
local floor = assert(_G.math.floor)
local ceil = assert(_G.math.ceil)
local log = assert(_G.math.log)
local sqrt = assert(_G.math.sqrt)
local pow = assert(_G.math.pow)
local tan = assert(_G.math.tan)
local cos = assert(_G.math.cos)
local sin = assert(_G.math.sin)
local math = assert(_G.math)
local pairs = assert(_G.pairs)
local sort = assert(_G.table.sort)
local tinsert = assert(_G.table.insert)
