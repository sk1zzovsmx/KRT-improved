...
function addon:ADDON_LOADED(name)
    ...
    self:RegisterEvent("CHAT_MSG_MONSTER_YELL", "CHAT_MSG_MONSTER_YELL")
    ...
    self:RegisterEvent("RAID_INSTANCE_WELCOME", "RAID_INSTANCE_WELCOME")
    -- Master Looter Events
    self:RegisterEvent("ITEM_LOCKED", "ITEM_LOCKED")
    self:RegisterEvent("LOOT_CLOSED", "LOOT_CLOSED")
    self:RegisterEvent("LOOT_OPENED", "LOOT_OPENED")
    self:RegisterEvent("LOOT_SLOT_CLEARED", "LOOT_SLOT_CLEARED")
