...
L.StrConfigHelpMasterLootBody = "/krt ml: open Master Loot.\n"
...
L.StrConfigHelpLootHistoryBody = "/krt history:\n"
    .. "show Loot History commands.\n"
    .. "/krt attendance: open Raid Attendance.\n"
    .. "/krt history req <raidNid> <player>: request snapshot.\n"
    .. "/krt history push <raidNid> <player>: push snapshot.\n"
    .. "/krt history sync: sync matching current raid data."
...
L.StrConfigLootHistorySyncNowDesc = "Runs the same current-raid sync used by /krt history sync."
