...
L.BtnLoggerRequireDatabase = "Require"
L.BtnLoggerPushDatabase = "Push"
L.BtnLoggerSyncNow = "Sync Now"
...
-- ==================== Configuration Frame ==================== --
L.StrConfigPanelTitle = "KRT"
L.StrConfigPanelMasterLoot = "Master Loot"
L.StrConfigPanelRaidWarning = "Raid Warning"
L.StrConfigPanelHelp = "Help"
L.StrConfigRootOverviewTitle = "Kader Raid Tools"
L.StrConfigRootOverviewBody = "KRT is a raid-leader toolkit for Wrath raids. Use the subpanels on the left to configure each workflow."
...
L.StrConfigRootHowBody = "KRT stores raid data locally, updates it from raid events and chat, and can sync current raid history with other KRT users."
...
L.StrConfigShowTooltipsDesc = "Shows KRT item details in item tooltips."
L.StrConfigShowLootCounterDuringMSRollDesc = "Displays the loot counter while an MS roll is active."
L.StrConfigMinimapButtonDesc = "Shows or hides the KRT minimap launcher."
...
L.StrConfigMasterLootPresetDefaultsDesc = "Restore the baseline KRT Master Loot configuration."
...
L.StrConfigHelpMasterLootBody = "/krt ml, /krt loot, /krt master: open Master Loot.\n"
    .. "/krt counter: open Loot Counter.\n"
    .. "/krt config: open the configuration popup.\n"
    .. "/krt config reset: restore default options."
L.StrConfigHelpLootHistoryTitle = "Loot History"
L.StrConfigHelpLootHistoryBody = "/krt logger, /krt history, /krt log:\n"
    .. "show Loot History commands.\n"
    .. "/krt attendance: open Raid Attendance.\n"
    .. "/krt logger req <raidNid> <player>: request snapshot.\n"
    .. "/krt logger push <raidNid> <player>: push snapshot.\n"
    .. "/krt logger sync: sync matching current raid data."
L.StrConfigHelpLFMSpamTitle = "LFM Spam"
L.StrConfigHelpLFMSpamBody = "/krt lfm, /krt pug, /krt group, /krt grouper:\n"
    .. "show LFM Spam commands.\n"
    .. "/krt lfm start: start LFM spam.\n"
    .. "/krt lfm stop: stop LFM spam.\n"
    .. "/krt ach [link]: print achievement ID."
L.StrConfigHelpRaidWarningTitle = "Raid Warning"
L.StrConfigHelpRaidWarningBody = "/krt rw, /krt warn, /krt warning, /krt warnings:\n" .. "show Raid Warning commands.\n" .. "/krt rw [ID]: announce warning by ID."
...
L.StrConfigHelpDiagnosticsBody = "/krt bug: print a local support summary.\n"
    .. "/krt version: print addon details and request group versions.\n"
    .. "/krt perf on|off: toggle slow-block diagnostics."
L.MsgAutoMasterLootSet = "KRT: Loot method set to Master Loot for %s."
L.MsgAutoMasterLootScreen = "Boss targeted, auto switch to Master Loot."
L.MsgGroupLootRestored = "KRT: Loot method set to Group Loot."
...
L.StrConfigLootHistoryPersistentSyncDesc = "Periodically syncs the current raid history with other KRT users in your group."
...
L.StrConfigLootHistorySyncNowDesc = "Runs the same current-raid sync used by /krt logger sync."
...
L.StrConfigRaidWarningPermissionBody = "Raid Warning announcements require raid leader or assistant permission. KRT falls back through "
...
L.BtnClose = "Close"
L.BtnSpamSoftResWhisper = "Spam SR"
...
L.StrReserveListAcceptSRTooltipText = "Allows players to whisper +sr [itemLink] or +softres [itemLink] " .. "to add a reserve. This changes local reserve data."
L.StrReserveListResponseWispTooltipTitle = "Response Wisp"
L.StrReserveListResponseWispTooltipText = "Allows players to whisper +sr or +softres " .. "to receive their current reserves. This does not change reserve data."
...
L.StrCmdPerf = "toggle performance logging: perf on|off|threshold <ms>|report|audit|sync|items|reset"
...
L.StrCmdPerfSync = "show sync payload byte chunk metrics"
...
L.MsgDebugRaidGridInvalidCount = "Use: /krt debug raidgrid [1-40]"
...
L.MsgTimerStatsTip = "Tip: /krt debug timers reset  |  sort: age|dur|target"
...
L.WhisperSoftResInvalidItem = "Shift-click an item link after +sr or +softres to add a reserve."
L.ChatSoftResWhisperHelpQuery = "SoftRes: To see your reserves /w %s +sr or /w %s +softres"
L.ChatSoftResWhisperHelpAdd = "SoftRes: To add one with /w %s +sr [item link] or /w %s +softres [item link]"
