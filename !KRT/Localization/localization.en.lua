...
L.StrCmdLoggerSync                     = "share the selected/current raid loot history to group"
L.StrCmdLoggerRequest                  = "request loot history sync from group"
...
L.MsgLoggerSyncNoRaid                  = "Logger sync: no selected/current raid to share."
L.MsgLoggerSyncShared                  = "Logger sync: shared raid #%d in %d message chunk(s)."
L.MsgLoggerSyncRequestSent             = "Logger sync: request sent to your group."
L.MsgLoggerSyncInvalid                 = "Logger sync: received invalid payload."
L.MsgLoggerSyncApplied                 = "Logger sync: merged data from %s into raid #%d."
