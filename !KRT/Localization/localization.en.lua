...
L.StrImportModeDescMulti               = "Each reserved item counts separately; players can reserve multiple items."
L.StrImportModeDescPlus                = "Uses the SoftRes CSV plus column as priority points (more plus = higher priority)."
