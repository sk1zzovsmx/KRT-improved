...
L.StrImportModeDescMulti               = "Each reserved item counts separately.\nPlayers can reserve multiple items."
L.StrImportModeDescPlus                = "Uses SoftRes CSV plus as priority points.\nMore plus means higher priority."
