...
L.TipLootCounterAnnounce = "Announce MS counts grouped by +N in raid chat."
...
L.StrLootCounterAnnounceNone = "MS Counter: no counted MS awards yet."
...
L.StrCmdDebugRaidRolls = "make the 4 synthetic players roll on the active item"
