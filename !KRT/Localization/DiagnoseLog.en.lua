...
Diag.D.LogBossLootTargetMatched = "[Boss] Loot target matched npcId=%d boss=%s"
Diag.D.LogBossRecentContextRecovered = "[Boss] Recovered recent context boss=%s bossNid=%d delta=%d"
