...
assertContains(configLua, "ScanRaidHistory", "Config widget must support Loot History scan/status actions")
...
assertContains(configLua, "CleanUpRaidHistory", "Config widget must route cleanup through logger actions")
