...
- _2026-03-06_: Master Looter buttons: countdown gates item selection, roll start, SR gated by reserved item, roll enabled after countdown, reset rolls on awards.
