...
!KRT/
  ...
  Services/
    ...
    Logger/
      ...
      Helpers.lua          # title formatters, empty-state text builders, raid ID translators
...
- `addon.Logger.Helpers`  - title formatters, empty-state text, raid ID translators (Services/Logger/Helpers.lua)
