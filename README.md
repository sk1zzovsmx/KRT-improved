...
Those are generated by GitHub and include the whole repository.
The ZIP still contains only the addon folder `!KRT/`.
...
GitHub publishing now starts from that changelog version metadata:
