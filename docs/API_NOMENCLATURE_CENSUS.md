...
| Metric | Value |
| --- | ---: |
| Scanned Lua files | 65 |
| API method definitions | 667 |
| Unique API surface | 667 |
| Public API surface | 642 |
| Internal API surface | 25 |
| Namespaces (`Target`) | 80 |

## Method Naming Distribution (All APIs)

| Style | Count | Percent |
| --- | ---: | ---: |
| PascalCase | 644 | 96.55% |
| UPPER | 21 | 3.15% |
