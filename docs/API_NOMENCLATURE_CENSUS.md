...
| Metric | Value |
| --- | ---: |
| Scanned Lua files | 67 |
| API method definitions | 685 |
| Unique API surface | 685 |
| Public API surface | 660 |
| Internal API surface | 25 |
| Namespaces (`Target`) | 82 |

## Method Naming Distribution (All APIs)

| Style | Count | Percent |
| --- | ---: | ---: |
| PascalCase | 662 | 96.64% |
| UPPER | 21 | 3.07% |
